...
export default function DateFilter() {
  ...
  const handleChange = (d: DatepickerEvent) => {
    ...
    setTimeout(() => {
      ...
      datePicker.scrollBy({
        left: pickedDatePosition - datePicker.clientWidth / 2 - 60,
        behavior: "smooth",
      });
    }, 20);
  };
  ...
  useEffect(() => {
    const datePicker = document.getElementsByClassName("dr")[0];
    console.log("scrollWidth: ", datePicker.scrollWidth);
    console.log("clientWidth: ", datePicker.clientWidth);
    datePicker.scrollBy({
      left: datePicker.scrollWidth / 2 - datePicker.clientWidth / 2 - 60,
      behavior: "smooth",
    });
  }, []);
