import { getSelfEvaluation } from "@/app/api/settings/actions/getSelfEvaluation";
...
export default function SelfEvaluation() {
  ...
  const handleSubmit = () => {
    ...
    startTransition(() => {
      updateQcm(questions, departement_id, "self_evaluation").then((data) => {
        if (data?.error) {
  ...
  useEffect(() => {
    ...
    startTransition(() => {
      getSelfEvaluation(departement_id).then((data: any) => {
        if (data?.success) {
          // const qcmData = data.success;
          // console.log("qcmData", qcmData);
          const qcmData = data.success.self_evaluation ?? [];
          console.log("qcmData", qcmData);
